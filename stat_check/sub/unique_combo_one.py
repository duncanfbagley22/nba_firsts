...
STAT_CONFIG = [
    ...
    {"stat": "game_day_of_week", "relevance": 2, "type": "unique", "rounding": "false", "rounding_value": 1, "allow_zeros": "false", "only_true": "false", "mutually_exclusive": []},
    ...
    {"stat": "venue", "relevance": 3, "type": "unique", "rounding": "false", "rounding_value": 1, "allow_zeros": "false", "only_true": "false", "mutually_exclusive": ["game_location"]},
...
def evaluate_staging_data():
    ...
    try:
        ...
        Y = 4  # Number of stats per combination
        ...
        while Y<=Y_max:
            ...
            X = 15 + X_increment # Number of unique combinations per player
